...
uses ServerMethodsUnit1, Web.WebReq, IdHashMessageDigest;
...
begin
  ...
  begin
    value := Request.GetFieldByName('If-None-Match');
    etag := GetHash(Response.Content);
    if(value = etag) then
    begin
      Response.Content := '';
      Response.StatusCode := 201;
    end;
    Response.SetCustomHeader('ETag', etag);
  end;
end;
...
function TWebModule1.GetHash(Value: string): string;
var
